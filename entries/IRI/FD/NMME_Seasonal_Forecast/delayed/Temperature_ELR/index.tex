...
1.0
16 systemtime systemtime2ymd 6 {
	ymd:lastmonth
}repeat
ymd2systemtime
...
/target_date { F
SOURCES .IRI .FD .NMME_Seasonal_Forecast .preview .Temperature_ELR .L add 1 add /long_name (forecast time) def /bounds undef /pointwidth 3 def /standard_name (time) def } defasvarsilent

/target_season {
SOURCES .IRI .FD .NMME_Seasonal_Forecast .preview .Temperature_ELR .target_season
F first target_date .F .last RANGE
} defasvarsilent

/prob {
SOURCES .IRI .FD .NMME_Seasonal_Forecast .preview .Temperature_ELR .prob
F first target_date .F .last RANGE
} defasvarsilent

/dominant {
SOURCES .IRI .FD .NMME_Seasonal_Forecast .preview .Temperature_ELR .dominant
F first target_date .F .last RANGE
} defasvarsilent
