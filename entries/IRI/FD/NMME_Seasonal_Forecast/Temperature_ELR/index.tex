...
/prob {
%[ X Y C | L F ] (/data/nachiketa/forecast_%b[F]_%Y[F]_tref_ELR.nc) [ F ] readdatafile:
%[ X Y C | L F ] (/data/mbell/dldata/iri.d/NMME_Seasonal_Forecast.d/forecast_tref_%b[F]_%Y[F]_ELR.nc) [ F ] readdatafile:
