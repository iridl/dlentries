...
/long_name (COLA-RSMAS-CCSM4 Seasonal Precipitation Hindcast) def
/description (COLA-RSMAS-CCSM4 seasonal hindcasts for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/NMME_Seasonal_Forecast/Hindcast/1991-2020/hindcast_seasonal_precip_%b[F]%Y[F]_COLA-RSMAS-CCSM4.nc) [ F ] readdatafile:
