...
/long_name (GFDL-SPEAR_Seasonal Precipitation Hindcast) def
/description (GFDL-SPEAR_ seasonal hindcasts for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/NMME_Seasonal_Forecast/Hindcast/2024/1991-2020/hindcast_seasonal_precip_%b[F]%Y[F]_GFDL-SPEAR.nc) [ F ] readdatafile:
