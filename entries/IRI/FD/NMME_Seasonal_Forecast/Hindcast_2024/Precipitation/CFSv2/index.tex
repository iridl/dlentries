...
/long_name (CFSv2 Seasonal Precipitation Hindcast) def
/description (CFSv2 seasonal hindcasts for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/NMME_Seasonal_Forecast/Hindcast/2024/1991-2020/hindcast_seasonal_precip_%b[F]%Y[F]_NCEP-CFSv2.nc) [ F ] readdatafile:
