...
/long_name (CanSIPS-IC3 Seasonal Precipitation Hindcast) def
/description (CanSIPS-IC3 seasonal hindcasts for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/NMME_Seasonal_Forecast/Hindcast/2024/1991-2020/hindcast_seasonal_precip_%b[F]%Y[F]_CanSIPS-IC3.nc) [ F ] readdatafile:
