...
/long_name (CanSIPS-IC3 Seasonal Temperature Hindcast) def
/description (CanSIPS-IC3 seasonal hindcasts for probabilities of below-normal, above-normal, and near-normal temperature, based on ELR method) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/NMME_Seasonal_Forecast/Hindcast/2024/1991-2020/hindcast_seasonal_tref_%b[F]%Y[F]_CanSIPS-IC3.nc) [ F ] readdatafile:
