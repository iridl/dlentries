...
/long_name (SubX MME South America weekly Temperature Probability Forecast) def
/description (SubX MME South America weekly probability forecasts of below-normal, above-normal, and near-normal temperature for Saturday-Friday target. MME forecast includes CFSv2, ESRL and GEFSv12) def
...
S {(/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_weekly/week12_T2M/MME_Subx_SAMER_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week12_forecast.nc) [ S ]} removeextrausing
name exch def
...
/prob {
[ X Y C | L S ] (/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_weekly/week12_T2M/MME_Subx_SAMER_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week12_forecast.nc) [ S ] readdatafile:
/name (prob) def
/units (percent) def
