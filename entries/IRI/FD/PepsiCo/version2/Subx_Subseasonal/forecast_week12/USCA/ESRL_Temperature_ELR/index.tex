...
/long_name (SubX ESRL USCA weekly Temperature Probability Forecast) def
/description (SubX ESRL USCA weekly probability forecasts of below-normal, above-normal, and near-normal temperature for Saturday-Friday target) def
...
S {(/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_weekly/week12_T2M/ESRL_Subx_USCA_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week12_forecast.nc) [ S ]} removeextrausing
name exch def
...
/prob {
[ X Y C | L S ] (/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_weekly/week12_T2M/ESRL_Subx_USCA_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week12_forecast.nc) [ S ] readdatafile:
/name (prob) def
/units (percent) def
