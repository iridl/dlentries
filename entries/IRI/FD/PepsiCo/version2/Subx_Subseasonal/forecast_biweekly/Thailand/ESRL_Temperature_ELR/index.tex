...
/long_name (SubX ESRL Thailand bi-weekly Temperature Probability Forecast) def
/description (SubX ESRL Thailand bi-weekly probability forecasts of below-normal, above-normal, and near-normal temperature for Saturday-Friday target) def
...
S {(/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_biweekly/biweekly_T2M/ESRL_Subx_THAI_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week234_forecast.nc) [ S ]} removeextrausing
name exch def
...
/prob {
[ X Y C | L S ] (/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_biweekly/biweekly_T2M/ESRL_Subx_THAI_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week234_forecast.nc) [ S ] readdatafile:
