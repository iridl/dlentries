...
/long_name (SubX MME bi-weekly Temperature Probability Forecast) def
/description (SubX MME bi-weekly probability forecasts of below-normal, above-normal, and near-normal temperature for Saturday-Friday target. SubX MME forecast, including EMC-GEFSv11, CFSv2 and ESRL stopped on Apr 30,2021; SubX MMEv21 forecast including GEFSv12, CFSv2 and ESRL, starts from May 7 2021) def
...
S {(/data/shared/jingyuan/Subx_forecast/mat/MME_Subx_forecast_T2M/MME_Subx_global_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week234_forecast.nc) [ S ]} removeextrausing
name exch def
...
/prob {
[ X Y C | L S ] (/data/shared/jingyuan/Subx_forecast/mat/MME_Subx_forecast_T2M/MME_Subx_global_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week234_forecast.nc) [ S ] readdatafile:
/name (prob) def
/units (percent) def
