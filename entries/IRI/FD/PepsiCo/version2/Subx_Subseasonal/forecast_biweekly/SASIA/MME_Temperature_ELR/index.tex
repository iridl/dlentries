...
/long_name (SubX MME South Asia bi-weekly Temperature Probability Forecast) def
/description (SubX MME South Asia bi-weekly probability forecasts of below-normal, above-normal, and near-normal temperature for Saturday-Friday target. SubX MME forecast, including GEFSv12, CFSv2 and ESRL model) def
...
S {(/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_biweekly/biweekly_T2M/MME_Subx_SASIA_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week234_forecast.nc) [ S ]} removeextrausing
name exch def
...
/prob {
[ X Y C | L S ] (/Data/data21/iri/FD/PepsiCo/Subx_forecast/forecast_biweekly/biweekly_T2M/MME_Subx_SASIA_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week234_forecast.nc) [ S ] readdatafile:
