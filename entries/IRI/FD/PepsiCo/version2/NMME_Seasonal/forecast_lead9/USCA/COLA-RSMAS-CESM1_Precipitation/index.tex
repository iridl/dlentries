...
/description (COLA-RSMAS-CESM1 model USCA long lead 9 seasonal forecast for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
/pointwidth 1 def
16 Apr 2024 ensotime
1.0
16 systemtime (%b %Y) 10 strftime interp ensotime
/netcdfgrid true def
:grid

F {(/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_year/forecast_seasonal_precip_%b[F]%Y[F]_lead9_COLA-RSMAS-CESM1_USCA.nc) [ F ]} removeextrausing
...
/prob {
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_year/forecast_seasonal_precip_%b[F]%Y[F]_lead9_COLA-RSMAS-CESM1_USCA.nc) [ F ] readdatafile:
