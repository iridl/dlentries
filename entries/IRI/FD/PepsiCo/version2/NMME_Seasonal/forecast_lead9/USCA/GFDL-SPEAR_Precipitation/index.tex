...
/description (GFDL-SPEAR model USCA long lead 9 seasonal forecast for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
F {(/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_year/forecast_seasonal_precip_%b[F]%Y[F]_lead9_GFDL-SPEAR_USCA.nc) [ F ]} removeextrausing
...
/prob {
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_year/forecast_seasonal_precip_%b[F]%Y[F]_lead9_GFDL-SPEAR_USCA.nc) [ F ] readdatafile:
