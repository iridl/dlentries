...
/description (NMME South America long lead 9 seasonal forecast for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method with 3 NMME models) def
...
F {(/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_year/forecast_seasonal_precip_%b[F]%Y[F]_lead9_fcst_3models_SAMER.nc) [ F ]} removeextrausing
...
/prob {
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_year/forecast_seasonal_precip_%b[F]%Y[F]_lead9_fcst_3models_SAMER.nc) [ F ] readdatafile:
