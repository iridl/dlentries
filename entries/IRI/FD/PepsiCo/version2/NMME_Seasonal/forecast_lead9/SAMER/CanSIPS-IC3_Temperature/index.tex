...
/description (CanSIPS-IC3 model South America long lead 9 seasonal forecasts for probabilities of below-normal, above-normal, and near-normal temperature, based on ELR method) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_year/forecast_seasonal_tref_%b[F]%Y[F]_lead9_CanSIPS-IC3_SAMER.nc) [ F ] readdatafile:
/name (prob) def
/units (percent) def
