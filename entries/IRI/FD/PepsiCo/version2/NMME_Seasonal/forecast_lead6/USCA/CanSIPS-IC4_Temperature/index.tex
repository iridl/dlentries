...
/description (CanSIPS-IC4 model USCA long lead 6 seasonal forecasts for probabilities of below-normal, above-normal, and near-normal temperature, based on ELR method) def
...
F {(/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_tref_%b[F]%Y[F]_lead6_CanSIPS-IC4_USCA.nc) [ F ]} removeextrausing
/expires
...
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_tref_%b[F]%Y[F]_lead6_CanSIPS-IC4_USCA.nc) [ F ] readdatafile:
/name (prob) def
/units (percent) def
