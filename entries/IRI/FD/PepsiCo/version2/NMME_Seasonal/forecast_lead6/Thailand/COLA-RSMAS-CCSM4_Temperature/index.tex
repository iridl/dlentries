...
/description (COLA-RSMAS-CCSM4 model Thailand long lead 6 seasonal forecasts for probabilities of below-normal, above-normal, and near-normal temperature, based on ELR method) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_tref_%b[F]%Y[F]_lead6_COLA-RSMAS-CCSM4_THAI.nc) [ F ] readdatafile:
/name (prob) def
/units (percent) def
