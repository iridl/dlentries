...
/description (NASA-GEOSS2S model South America long lead 6 seasonal forecasts for probabilities of below-normal, above-normal, and near-normal temperature, based on ELR method) def
...
F {(/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_tref_%b[F]%Y[F]_lead6_NASA-GEOSS2S_SAMER.nc) [ F ]} removeextrausing
/expires
...
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_tref_%b[F]%Y[F]_lead6_NASA-GEOSS2S_SAMER.nc) [ F ] readdatafile:
/name (prob) def
/units (percent) def
