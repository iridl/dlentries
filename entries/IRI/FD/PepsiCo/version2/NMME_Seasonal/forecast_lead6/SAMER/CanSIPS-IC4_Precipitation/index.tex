...
/description (CanSIPS-IC4 model South America long lead 6 seasonal forecast for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
/pointwidth 1 def
16 Jul 2024 ensotime
1.0
16 systemtime (%b %Y) 10 strftime interp ensotime
/netcdfgrid true def
:grid

F {(/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_precip_%b[F]%Y[F]_lead6_CanSIPS-IC4_SAMER.nc) [ F ]} removeextrausing
...
/prob {
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_precip_%b[F]%Y[F]_lead6_CanSIPS-IC4_SAMER.nc) [ F ] readdatafile:
