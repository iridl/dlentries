...
/description (GFDL-SPEAR model South Asia long lead 6 seasonal forecast for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method) def
...
F {(/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_precip_%b[F]%Y[F]_lead6_GFDL-SPEAR_SASIA.nc) [ F ]} removeextrausing
...
/prob {
[ X Y C | L F ] (/Data/data21/iri/FD/PepsiCo/NMME_seasonal_forecast_lead6/forecast_seasonal_precip_%b[F]%Y[F]_lead6_GFDL-SPEAR_SASIA.nc) [ F ] readdatafile:
