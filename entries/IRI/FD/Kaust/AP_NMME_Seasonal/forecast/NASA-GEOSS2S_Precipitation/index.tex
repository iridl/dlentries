...
/description (NASA-GEOSS2S model AP seasonal forecast for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method with new period 1991-2020) def
...
F {(/Data/data21/iri/FD/Kaust/NMME_seasonal_forecast/forecast_seasonal_precip_%b[F]%Y[F]_lead4_NASA-GEOSS2S_AP.nc) [ F ]} removeextrausing
...
/prob {
[ X Y C | L F ] (/Data/data21/iri/FD/Kaust/NMME_seasonal_forecast/forecast_seasonal_precip_%b[F]%Y[F]_lead4_NASA-GEOSS2S_AP.nc) [ F ] readdatafile:
