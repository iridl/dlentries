...
/description (AP NMME seasonal forecasts for probabilities of below-normal, above-normal, and near-normal temperature, based on ELR method, with 5 NMME models and new period 1991-2020) def
...
F {(/Data/data21/iri/FD/Kaust/NMME_seasonal_forecast/forecast_seasonal_tref_%b[F]%Y[F]_lead4_fcst_5models_AP.nc) [ F ]} removeextrausing
/expires
...
[ X Y C | L F ] (/Data/data21/iri/FD/Kaust/NMME_seasonal_forecast/forecast_seasonal_tref_%b[F]%Y[F]_lead4_fcst_5models_AP.nc) [ F ] readdatafile:
/name (prob) def
/units (percent) def
