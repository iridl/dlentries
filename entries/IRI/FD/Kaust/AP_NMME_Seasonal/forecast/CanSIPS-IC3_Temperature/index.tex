...
/description (CanSIPS-IC3 model AP seasonal forecasts for probabilities of below-normal, above-normal, and near-normal temperature, based on ELR method, with new period 1991-2020) def
...
F {(/Data/data21/iri/FD/Kaust/NMME_seasonal_forecast/forecast_seasonal_tref_%b[F]%Y[F]_lead4_CanSIPS-IC3_AP.nc) [ F ]} removeextrausing
/expires
...
[ X Y C | L F ] (/Data/data21/iri/FD/Kaust/NMME_seasonal_forecast/forecast_seasonal_tref_%b[F]%Y[F]_lead4_CanSIPS-IC3_AP.nc) [ F ] readdatafile:
/name (prob) def
/units (percent) def
