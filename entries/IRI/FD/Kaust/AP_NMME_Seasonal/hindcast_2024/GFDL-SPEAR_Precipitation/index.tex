...
/description (GFDL-SPEAR model AP seasonal hindcasts for probabilities of below-normal, above-normal, and near-normal precipitation, based on ELR method with  new period 1991-2020) def
...
[ X Y C | L F ] (/Data/data21/iri/FD/Kaust/NMME_seasonal_hindcast/2024_newCOLA/hindcast_seasonal_precip_%b[F]%Y[F]_GFDL-SPEAR_AP.nc) [ F ] readdatafile:
