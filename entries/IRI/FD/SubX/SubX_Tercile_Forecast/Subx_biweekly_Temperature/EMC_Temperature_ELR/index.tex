...
/long_name (SubX EMC bi-weekly Temperature Probability Forecast) def
/description (SubX EMC bi-weekly probability forecasts of below-normal, above-normal, and near-normal temperature for Saturday-Friday target. EMC-GEFSv11 model stopped on Apri 30 2021) def
...
/prob {
[ X Y C | L S ] (/data/shared/jingyuan/Subx_forecast/mat/MME_Subx_forecast_T2M/EMC_Subx_global_t2m_issue_Fri_%d[S]_%b[S]_%Y[S]_week234_forecast.nc) [ S ] readdatafile:
