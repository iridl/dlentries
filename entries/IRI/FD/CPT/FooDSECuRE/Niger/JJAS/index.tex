...
/PearsonR_prcp {
    ...
    (/data/ckelley/WFP/Niger/201*%m[S]/Skill_prcp_JJAS_S%m[S].txt)  [S 12 splitgrid pop] 
      readdatafile:
        [3 1] r*8astsv 
      :readdatafile
...
(/data/ckelley/WFP/Niger/201*%m[S]/CrossValPred_prcp_JJAS_S%m[S].txt) [S 12 splitgrid pop]
	  readdatafile:
        [2 1 1] r*8astsv
      :readdatafile
S2 -12 shiftGRID
...
/Input_prcp {
      [ X Y last first subgrid S 12 splitgrid nip | S 12 splitgrid pop ]
(/data/ckelley/WFP/Niger/201*%m[S]/YInput_prcp_JJAS_S%m[S].txt) [S 12 splitgrid pop]
          readdatafile:
        [2 1 1] r*8astsv
      :readdatafile
S2 -12 shiftGRID
...
S { (/data/ckelley/WFP/Niger/%Y%m[S]/Forecasts_prcp_JJAS_S%Y%m[S].txt) [S] } removeextrausing
      /expires
        systemtime
        last_modified sub
        86400 lt {
...
(/data/ckelley/WFP/Niger/%Y%m[S]/Forecasts_prcp_JJAS_S%Y%m[S].txt) [S]
      readdatafile:
        [3 1] r*8astsv
      :readdatafile
        /missing_value -9999. def
...
%(/data/ckelley/WFP/Niger/%Y%m[S]/TercileProbs_prcp_JJAS_S%Y%m[S].txt) [S]
%	readdatafile:
%	[ 2 1 2] r*8astsv
%	:readdatafile
...
%	}defasvarsilent
	...
	/PredErrVar_prcp {
      [ X Y last first subgrid | S ]
(/data/ckelley/WFP/Niger/%Y%m[S]/PredErrVar_prcp_JJAS_S%Y%m[S].txt) [S]    
  readdatafile:
        [3 1] r*8astsv
      :readdatafile
      /missing_value -9999. def
