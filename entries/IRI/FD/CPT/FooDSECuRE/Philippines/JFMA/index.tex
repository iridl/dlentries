\begin{ingrid}
/description (JFMA Forecasts) def
...
/PearsonR_WD1 {
    ...
    (/data/simon/WFP/Philippines/2008%m[S]/Skill_freq_JFMA_S%m[S].txt)  [S 12 splitgrid pop] 
      readdatafile:
        [3 0] r*8astsv 
      :readdatafile
mycol second VALUE
...
provcode2 gid replaceGRID
        /long_name (WD1 Pearson's Correlation) def
        /units (unitless) def
...
(/data/simon/WFP/Philippines/2008%m[S]/CrossValPred_freq_JFMA_S%m[S].txt) [S 12 splitgrid pop]
	  readdatafile:
        [3 1] r*8astsv
      :readdatafile
S2 -12 shiftGRID
...
provcode2 provcode SAMPLE
provcode2 gid replaceGRID
        /long_name (WD1 cross-validated hindcasts) def
        /units /days def
        /missing_value -9999. def
wetday_freq_colors
DATA 0 AUTO RANGE
...
/Input_WD1 {
      [ provcode2 S 12 splitgrid nip | S 12 splitgrid pop ]
(/data/simon/WFP/Philippines/2008%m[S]/YInput_freq_JFMA_S%m[S].txt) [S 12 splitgrid pop]
          readdatafile:
        [3 1] r*8astsv
      :readdatafile
S2 -12 shiftGRID
...
provcode2 provcode SAMPLE
provcode2 gid replaceGRID
        /long_name (WD1 input observations) def
        /units /days def
        /missing_value -9999. def
wetday_freq_colors
DATA 0 AUTO RANGE
...
S { (/data/simon/WFP/Philippines/%Y%m[S]/Forecasts_freq_JFMA_S%Y%m[S].txt) [S] } removeextrausing
      /expires
        systemtime
        last_modified sub
        86400 lt {
...
/Forecast_WD1 {
      [ provcode2 | S ]
(/data/simon/WFP/Philippines/%Y%m[S]/Forecasts_freq_JFMA_S%Y%m[S].txt) [S]
      readdatafile:
        [3 1] r*8astsv
      :readdatafile
provcode2 provcode SAMPLE
provcode2 gid replaceGRID
        /missing_value -9999. def
        /long_name (WD1 current forecast) def
/units /days def
wetday_freq_colors
DATA 0 AUTO RANGE
    }defasvarsilent
	...
	/TercileProb_WD1 {
	[provcode2 C | S ]
(/data/simon/WFP/Philippines/%Y%m[S]/TercileProbs_freq_JFMA_S%Y%m[S].txt) [S]
	readdatafile:
	[ 2 1 2] r*8astsv
	:readdatafile
provcode2 provcode SAMPLE
provcode2 gid replaceGRID
	...
	/PredErrVar_WD1 {
      [ provcode2 | S ]
(/data/simon/WFP/Philippines/%Y%m[S]/PredErrVar_freq_JFMA_S%Y%m[S].txt) [S]    
  readdatafile:
        [3 1] r*8astsv
      :readdatafile
provcode2 provcode SAMPLE
provcode2 gid replaceGRID
      /missing_value -9999. def
      /long_name (WD1 prediction error variance) def
      /units /days2 def
wetday_freq_colors
DATA 0 AUTO RANGE
    }defasvarsilent
...
[TercileProb_WD1]dominant_class exch}
     forall pop
     3 index
      22 masklt
      add
...
/long_name (WD1 Dominant Tercile Probabilities) def
}defasvar
