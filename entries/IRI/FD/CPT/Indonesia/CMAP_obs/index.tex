\begin{ingrid}
  ...
  /description (Predicand, Hindcast and Skill) def
    ...
    grid:
      ...
      91.25 to 163.75 N= 30 pts
    :grid
    grid:
      /name (Y) def
      /units (degreeN) def
      /long_name (Latitude) def
      11.25 to -8.75 N= 9 pts
    :grid
    grid:
      /name (L) def
      /units (months) def
...
/hindcast_date {S L add /long_name (hindcast time) def /pointwidth 3 def} defasvar
    ...
    /PearsonR {
      ...
      (/Data/data1/iri/forecast/data/echam/Indonesia/CMAP/PearsonR_Start%-m[S]_Lead%d[L].txt) [S 12 splitgrid pop L 1.5 sub]
      readdatafile: 
        [4 1] r*4astsv 
      :readdatafile
        /name (PearsonR) def
    ...
    /CrossValHind {
      ...
      (/Data/data1/iri/forecast/data/echam/Indonesia/CMAP/CrossValPred_Start%-m[S]_Lead%d[L].txt) [S 12 splitgrid pop L 1.5 sub]
      readdatafile:
        [2 1 3] r*4astsv
      :readdatafile
  ...
  S
   ...
   12 shiftGRID
    ...
    /InputObs {
      [ X Y S 12 splitgrid nip | S 12 splitgrid pop L ]
      (/Data/data1/iri/forecast/data/echam/Indonesia/CMAP/YinputData_Start%-m[S]_Lead%d[L].txt) [S 12 splitgrid pop L 1.5 sub]
      readdatafile:
        [2 1 3] r*4astsv
      :readdatafile
        /name (InputObs) def
  ...
  S
   ...
   12 shiftGRID
    ...
    grid:
      ...
      def
    :grid
S { (/Data/data1/iri/forecast/data/echam/Indonesia/CMAP/Forecasts_%Y_Start%-m[S]_Lead1.txt) [S] } removeextrausing
   name exch def
    ...
    /Forecast {
      [ X Y | S L ]
      (/Data/data1/iri/forecast/data/echam/Indonesia/CMAP/Forecasts_%Y_Start%-m[S]_Lead%d[L].txt) [S L 1.5 sub]
      readdatafile:
        [5 1] r*4astsv
      :readdatafile
        /missing_value -999. def
    ...
    /PredErrorVars {
      [ X Y | S L ]
      (/Data/data1/iri/forecast/data/echam/Indonesia/CMAP/PredErrorVars_%Y_Start%-m[S]_Lead%d[L].txt) [S L 1.5 sub]
      readdatafile:
        [5 1] r*4astsv
      :readdatafile
        /missing_value -999. def
