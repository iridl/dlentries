...
/correlation { 
/long_name (prec) def 
 SOURCES .EU .Copernicus .CDS .C3S .DWD .GCFS2p0 .hindcast .prcp
  ...
  c:
   86400 (s day-1) :c
   mul
  SOURCES .IRI .Analyses .SCIPSA .DWD .hindcast .sc .prec sub
  SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
   ...
   SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
    ...
    sub
   [X Y]regridLinear
   SOURCES .EU .Copernicus .CDS .C3S .DWD .GCFS2p0 .hindcast .T
    S (0000 1 Jan 1993) (0000 1 Dec 2016) RANGE
    T sample-along
...
/correlation {
/long_name (temp) def
 SOURCES .EU .Copernicus .CDS .C3S .DWD .GCFS2p0 .hindcast .t2m
  S (0000 1 Jan 1981) (0000 1 Dec 2010) RANGE
  [M]average
  L 3 runningAverage
  (Celsius_scale) unitconvert
  SOURCES .IRI .Analyses .SCIPSA .DWD .hindcast .sc .temp sub
...
/correlation {
/long_name (sst) def 
SOURCES .EU .Copernicus .CDS .C3S .DWD .GCFS2p0 .hindcast .sst
  S (0000 1 Jan 1981) (0000 1 Dec 2010) RANGE
  [M]average
  L 3 runningAverage
  (Celsius_scale) unitconvert
  SOURCES .IRI .Analyses .SCIPSA .DWD  .hindcast .sc .sst sub
