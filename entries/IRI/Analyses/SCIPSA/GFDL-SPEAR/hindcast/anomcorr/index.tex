...
/correlation { 
/long_name (prec) def 
 SOURCES .Models .NMME .GFDL-SPEAR .HINDCAST .MONTHLY .prec
  S (0000 1 Jan 1991) (0000 1 Dec 2020) RANGE
  [M]average
  L 3 runningAverage
  c:
   1000 (mm m-1) :c
  ...
  c:
   86400 (s day-1) :c
   mul
  SOURCES .Models .NMME .GFDL-SPEAR .HINDCAST .sc9120 .prec sub
  SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
   ...
   SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
    ...
    sub
   [X Y]regridLinear
    SOURCES .Models .NMME .GFDL-SPEAR .HINDCAST .MONTHLY .T
    S (0000 1 Jan 1991) (0000 1 Dec 2020) RANGE
    T sample-along
...
/correlation {
/long_name (temp) def
 SOURCES .Models .NMME .GFDL-SPEAR .HINDCAST .MONTHLY .tref
  S (0000 1 Jan 1991) (0000 1 Dec 2020) RANGE
  [M]average
  L 3 runningAverage
  (Celsius_scale) unitconvert
  SOURCES .Models .NMME .GFDL-SPEAR .HINDCAST .sc9120 .tref sub
...
SOURCES .Models .NMME .GFDL-SPEAR .HINDCAST .MONTHLY .sst
  ...
  L 3 runningAverage
  (Celsius_scale) unitconvert
  SOURCES .Models .NMME .GFDL-SPEAR .HINDCAST .sc9120 .sst sub
