...
/long_name (prec) def 
 SOURCES .EU .Copernicus .CDS .C3S .CMCC .SPSv3 .hindcast .prcp
  ...
  c:
   86400 (s day-1) :c
   mul
  SOURCES .IRI .Analyses .SCIPSA  .CMCC .hindcast .sc .prec sub
  SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
   ...
   SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
    ...
    sub
   [X Y]regridLinear
   SOURCES .EU .Copernicus .CDS .C3S .CMCC .SPSv3 .hindcast .T
    S (0000 1 Jan 1993) (0000 1 Dec 2016) RANGE
    T sample-along
...
/long_name (temp) def
 SOURCES .EU .Copernicus .CDS .C3S .CMCC .SPSv3 .hindcast .t2m
  ...
  SOURCES .IRI .Analyses .SCIPSA .CMCC .hindcast .sc .temp sub
...
SOURCES .EU .Copernicus .CDS .C3S .CMCC .SPSv3 .hindcast .sst
  ...
  L 3 runningAverage
  (Celsius_scale) unitconvert
  SOURCES .IRI .Analyses .SCIPSA .CMCC .hindcast .sc .sst sub
