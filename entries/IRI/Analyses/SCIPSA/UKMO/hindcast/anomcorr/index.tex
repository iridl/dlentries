...
/correlation { 
/long_name (prec) def 
 SOURCES .EU .Copernicus .CDS .C3S .UKMO .GloSea5-GC2 .System14 .hindcast .prcp
  ...
  c:
   86400 (s day-1) :c
   mul
  SOURCES .IRI .Analyses .SCIPSA .UKMO  .hindcast .sc .prec sub
  SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
   ...
   SOURCES .NOAA .NCEP .CPC .CAMS_OPI .v0208 .mean .prcp
    ...
    sub
   [X Y]regridLinear
   SOURCES .EU .Copernicus .CDS .C3S .UKMO .GloSea5-GC2 .System14 .hindcast .T
    S (0000 1 Jan 1993) (0000 1 Dec 2016) RANGE
    T sample-along
...
/correlation {
/long_name (temp) def
 SOURCES .EU .Copernicus .CDS .C3S .UKMO .GloSea5-GC2 .System14 .hindcast .t2m
  S (0000 1 Jan 1993) (0000 1 Dec 2016) RANGE
  [M]average
  L 3 runningAverage
  (Celsius_scale) unitconvert
  SOURCES .IRI .Analyses .SCIPSA .UKMO  .hindcast .sc .temp sub
  SOURCES .NOAA .NCEP .CPC .GHCN_CAMS .gridded .deg0p5 .temp
   T (Dec 1980) last RANGE
   T 3 runningAverage
   SOURCES .NOAA .NCEP .CPC .GHCN_CAMS .gridded .deg0p5 .temp
    T (Dec 1993) (Jan 2016) RANGE
    T 3 runningAverage
    T 12 splitstreamgrid
    [T2]average
    sub
...
/correlation {
/long_name (sst) def 
SOURCES .EU .Copernicus .CDS .C3S .UKMO .GloSea5-GC2 .System14 .hindcast .sst
  S (0000 1 Jan 1993) (0000 1 Dec 2016) RANGE
  [M]average
  L 3 runningAverage
  (Celsius_scale) unitconvert
  SOURCES .IRI .Analyses .SCIPSA .UKMO .hindcast .sc .sst sub
