...
/tref {
%[ X Y | Z L M S ] (/data/dstore4/iri/modelling/datag/NMME_Data.D/CMC1_CanCM3.D/Hindcast.D/%b[S].D/tmp2m.%Y[S]%m[S]%d[S]00.%2.2d[M].CMC1.fcst.avrg.1x1.grb) [ M S ]
[ X Y | Z L M S ] (/Data/data23/NMME/CMC1_CanCM3.D/Hindcast.D/%b[S].D/tmp2m.%Y[S]%m[S]%d[S]00.%2.2d[M].CMC1.fcst.avrg.1x1.grb) [ M S ]
readdatafile: 
/name (tmp2m) def
