...
[ X Y | Z L M S ] (/Data/data23/NMME/CMC2_CanCM4.D/Hindcast.D/%b[S].D/tmp2m.%Y[S]%m[S]%d[S]00.%2.2d[M].CMC2.fcst.avrg.1x1.grb) [ M S ]
readdatafile: 
/name (tmp2m) def
...
/tmax {
[ X Y | Z L M S ] (/Data/data23/NMME/CMC2_CanCM4.D/Hindcast.D/%b[S].D/tmax.%Y[S]%m[S]%d[S]00.%2.2d[M].CMC2.fcst.avrg.1x1.grb)
[ M S ]
readdatafile: 
/name (tmax) def
...
/tmin {
[ X Y | Z L M S ] (/Data/data23/NMME/CMC2_CanCM4.D/Hindcast.D/%b[S].D/tmin.%Y[S]%m[S]%d[S]00.%2.2d[M].CMC2.fcst.avrg.1x1.grb)
[ M S ]
readdatafile: 
/name (tmin) def
