...
/historical {
 SOURCES .CCROM .Lao .stations
  ...
  (MinTemp)
   ...
   (PerDA) eq
   {a: .Tmin dataflag :a: .Tmax dataflag :a mul }if
  (1)
   /DayStart parameter
   ( ) append
   (Jan)
  ...
  /seasonalStat get_parameter
   (HDD) eq
   {4 -1 roll a: .Tmax :a: .Tmin :a add 2.0 div 3 -1 roll sub 0 maskge abs 3 -2 roll flexseastotZeroFill -1 replaceNaN}if
  /seasonalStat get_parameter
   (NumCD) eq
