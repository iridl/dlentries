    ...
    (1)
     ...
     (0.5)
      ...
      /seasonalStat get_parameter
       (TotRain) eq
       {nip nip 3 -1 roll .PCPN 3 -2 roll flexseastotAvgFill}if
  /seasonalStat get_parameter
   (NumWD) eq
   {3 -1 roll pop 4 -1 roll .PCPN 4 -3 roll flexseasonalfreqGT}if
  /seasonalStat get_parameter
   (RainInt) eq
   {3 -1 roll pop 4 -1 roll .PCPN 4 -3 roll flexseasonalmeandailyvalueGT}if
  /seasonalStat get_parameter
   (NumDS) eq
   {5 -1 roll .PCPN 5 -4 roll flexseasonalnonoverlapDSfreq}if
  /seasonalStat get_parameter
   (NumWS) eq
   {5 -1 roll .PCPN 5 -4 roll flexseasonalnonoverlapWSfreq}if
  /seasonalStat get_parameter
   (PerDA) eq
