...
/filename {
T 
   (/Data/data7/nasa/avhrr/ndvi/south_america/%Y/avhrrpf.ndvi.1ntfsa.%y%m%d) strftimes
} def
:datasetdefs
...
file:
ui*2
/name (/Data/data7/nasa/avhrr/ndvi/south_america/ancillary/avhrrpf.lon.1nnfsa) def
:file
/scale_factor .01 def
...
file:
i*2
/name (/Data/data7/nasa/avhrr/ndvi/south_america/ancillary/avhrrpf.lat.1nnfsa) def
:file
/scale_factor .01 def
...
file:
i*2
/name (/Data/data7/nasa/avhrr/ndvi/south_america/ancillary/avhrrpf.elev.1nnfsa) def
:file
/scale_factor 1 def
...
/NDVI {
[x y | T] 
(/Data/data7/nasa/avhrr/ndvi/south_america/%Y/avhrrpf.ndvi.1ntfsa.%y%m%d[firstday])
 [T dup integralgrid
        first secondtolast subgrid
        .gridvalues
        1 index
