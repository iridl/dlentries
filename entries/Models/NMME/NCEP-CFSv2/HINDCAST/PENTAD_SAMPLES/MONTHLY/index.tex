...
/tref {
 SOURCES .Models .NMME .NCEP-CFSv2 .MONTHLY .tref
  ...
  M 1.0 VALUE
  S last VALUE
  SOURCES .NOAA .NCEP .EMC .CFSv2 .ENSEMBLE .FLXF .2m_above_ground .TMP
   [X Y]regridAverage
   nip
...
/sst {
 SOURCES .NOAA .NCEP .EMC .CFSv2 .ENSEMBLE .OCNF .surface .TMP
  Y -90 90 RANGE
...
/hgt {
SOURCES .NOAA .NCEP .EMC .CFSv2 .ENSEMBLE .PGBF .pressure_level .HGT
  P 200 VALUE
  Y -90 90 RANGE
