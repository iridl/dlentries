...
/S SOURCES .NOAA .NCEP .EMC .CFSv2 .REALTIME_ENSEMBLE .FLXF .T .S def
continuedataset:

link:
/name (SamplingTable) def
/href (http://iridl.ldeo.columbia.edu/SOURCES/.NOAA/.NCEP/.EMC/.CFSv2/.REALTIME_ENSEMBLE/.FLXF/mark/sampleS/M/4/STEP/S/exch%5BM%5Dtable:/mark/:table/.html) def
...
/tref {
 SOURCES .Models .NMME .NCEP-CFSv2 .MONTHLY .tref
  ...
  M 1.0 VALUE
  S last VALUE
  SOURCES .NOAA .NCEP .EMC .CFSv2 .REALTIME_ENSEMBLE .FLXF .2m_above_ground .TMP
   [X Y]regridAverage
   nip
...
/sst {
 SOURCES .NOAA .NCEP .EMC .CFSv2 .REALTIME_ENSEMBLE .OCNF .surface .TMP
  Y -90 90 RANGE
...
/hgt {
SOURCES .NOAA .NCEP .EMC .CFSv2 .REALTIME_ENSEMBLE .PGBF .pressure_level .HGT
 P 200 VALUE
 Y -90 90 RANGE
...
/T { SOURCES .NOAA .NCEP .EMC .CFSv2 .REALTIME_ENSEMBLE .FLXF .T } defasvarsilent
