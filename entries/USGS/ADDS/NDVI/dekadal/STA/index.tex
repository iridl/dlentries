\begin{ingrid}
/description (Short-term (1995-1999) mean NDVI from ADDS) def
continuedataset:
...
/NDVI {[| T] (/Data/data6/usgs/adds/ndvi/ndviesav/asm%m[T]%d[dekad]nd.IMG) [T dup day2dom 5. add 10. div toi4 /name /dekad def ]
readdatafile:
IDAimage
:readdatafile
/valid_min 1 def
