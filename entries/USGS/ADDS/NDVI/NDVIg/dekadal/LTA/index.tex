\begin{ingrid}
/description (Long-term Average (1982-2003 base period) Dekadal NDVIg data) def
continuedataset:
datasetdefs:
/filename {T (/Data/data6/usgs/adds/ndvi/ndvig/ndvigltav/alm%m%d[dekad]nd.bil) strftimes}def
/adds_ndvi_colors {
startcolormap
DATA 0.0 1.0 RANGE
...
/NDVI {[ x y | T] (/Data/data6/usgs/adds/ndvi/ndvig/ndvigltav/alm%m[T]%d[dekad]nd.bil) [T dup 1 object
...
:dataset
%T { (/Data/data6/usgs/adds/ndvi/ndvig/ndvigltav/alm%m[T]%d[dekad]nd.bil) [T dup day2dom 5. add 10. div toi4 /name /dekad def]}removeextrausing
%name exch def
\end{ingrid}
