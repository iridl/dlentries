\begin{ingrid}
/description (Short-term Average (1999-2003 base period) Dekadal NDVIg data) def
continuedataset:
datasetdefs:
/filename {T (/Data/data6/usgs/adds/ndvi/ndvig/ndvigstav/asm%m%d[dekad]nd.bil) strftimes}def
/adds_ndvi_colors {
startcolormap
DATA 0.0 1.0 RANGE
...
/NDVI {[ x y | T] (/Data/data6/usgs/adds/ndvi/ndvig/ndvigstav/asm%m[T]%d[dekad]nd.bil) [T dup 1 object
/calendar /standard def day2dom 5. add 10. div toi4 /name /dekad def ]
readdatafile:
%readui1direct
ui*1
:readdatafile
...
:dataset
%T { (/Data/data6/usgs/adds/ndvi/ndvig/ndvigltav/asm%m[T]%d[dekad]nd.bil) [T dup day2dom 5. add 10. div toi4 /name /dekad def]}removeextrausing
%name exch def
\end{ingrid}
