\begin{ingrid}
/description (Short-term (1995-1999) mean NDVIe from ADDS) def
continuedataset:
/long_name (Short-term average) def
datasetdefs:
/filename {T (/Data/data6/usgs/adds/ndvi/ndviesav/asm%m%d[dekad]nd.IMG) strftimes}def
/adds_ndvi_colors {
startcolormap
DATA 0 1 RANGE
...
21 Dec 1959 julian_day %enddate
dekadGRID
...
/NDVI {[| T] (/Data/data6/usgs/adds/ndvi/ndviesav/asm%m[T]%d[dekad]nd.IMG) [T dup 1 object /calendar /standard
def day2dom 5. add 10. div toi4 /name /dekad def ]
readdatafile:
IDAimage
:readdatafile
/valid_min 1 def
...
:dataset
%T { (/Data/data6/usgs/adds/ndvi/ndviesav/asm%m[T]%d[dekad]nd.IMG) [T dup day2dom 5. add 10. div toi4 /name /dekad def]}removeextrausing
%name exch def
\end{ingrid}
