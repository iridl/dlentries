...
output image corners (lat/lon):
    UL:  49.000000000000 -126.100000000000 
    UR:  49.000000000000 -62.999615298181 
    LL:  12.999580224815 -126.100000000000 
    LR:  12.999580224815 -62.999615298181 

output image corners (X-Y projection units):
    UL:  -126.100000000000 49.000000000000 
    UR:  -62.999615298181 49.000000000000 
    LL:  -126.100000000000 12.999580224815 
    LR:  -62.999615298181 12.999580224815 

     band               type lines smpls pixsiz      min    max   fill
  1) 250m 16 days NDVI  INT16 14812 25962 0.0024  -2000  10000  -3000
\begin{ingrid}
...
/long_name (Southern North America) def
grid:
/name /X def
degE
%-82. -33.999977057134
%2 copy exch sub 22997 div exch
-126.10 -62.999615298181
2 copy exch sub 25962 div exch
...
%2 copy exch sub 15811 div exch
 49.0  12.999580224815
2 copy exch sub 14812 div exch
% converts edges to centers
1 index .5 mul sub
3 -1 roll
2 index .5 mul add
...
/reflectance
{[X Y | band T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA3.250m_16_days_%s[band]_reflectance.dat.gz)
...
/NDVI
{[X | Y T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA3.250m_16_days_NDVI.dat.gz)
...
/VI_Quality
{[X | Y T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA3.250m_16_days_VI_Quality.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
...
/EVI
{[X | Y T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA3.250m_16_days_EVI.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
/missing_value -3000 def
/valid_min -2000 def
...
/view_zenith_angle
{[X | Y T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA3.250m_16_days_view_zenith_angle.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
