...
output image corners (lat/lon):
    UL:  74.800000000000 -126.100000000000 
    UR:  74.800000000000 -53.198325460122 
    LL:  48.995584925031 -126.100000000000 
    LR:  48.995584925031 -53.198325460122 

output image corners (X-Y projection units):
    UL:  -126.100000000000 74.800000000000 
    UR:  -53.198325460122 74.800000000000 
    LL:  -126.100000000000 48.995584925031 
    LR:  -53.198325460122 48.995584925031 

     band               type lines smpls pixsiz      min    max   fill
  1) 250m 16 days NDVI  INT16  5834 16482 0.0044  -2000  10000  -3000

End Time:  Thu Oct 22 14:17:26 2009
...
/long_name (Canada) def
grid:
/name /X def
degE
-126.10 -53.197663129728
2 copy exch sub 16536 div exch
...
/name /Y def
degN
74.6 48.998653228975
2 copy exch sub 5807 div exch
% converts edges to centers
1 index .5 mul sub
3 -1 roll
2 index .5 mul add
...
/reflectance
{[X Y | band T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA2.250m_16_days_%s[band]_reflectance.dat.gz)
...
/NDVI
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA2.250m_16_days_NDVI.dat.gz)
...
/VI_Quality
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA2.250m_16_days_VI_Quality.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
...
/EVI
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA2.250m_16_days_EVI.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
/missing_value -3000 def
/valid_min -2000 def
...
/view_zenith_angle
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA2.250m_16_days_view_zenith_angle.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
