...
output image corners (lat/lon):
    UL:  71.520000000000 -168.200000000000 
    UR:  71.520000000000 -126.097752439038 
    LL:  48.996872451926 -168.200000000000 
    LR:  48.996872451926 -126.097752439038 

output image corners (X-Y projection units):
    UL:  -168.200000000000 71.520000000000 
    UR:  -126.097752439038 71.520000000000 
    LL:  -168.200000000000 48.996872451927 
    LR:  -126.097752439038 48.996872451927 

     band               type lines smpls pixsiz      min    max   fill
  1) 250m 16 days NDVI  INT16  5363 10025 0.0042  -2000  10000  -3000

End Time:  Tue Oct 20 10:07:33 2009
\begin{ingrid}
continuedataset:
datasetdefs:
/ndvi_colorsMODIS {
...
/long_name (Alaska) def
grid:
/name /X def
degE
-168.2 -126.097752439038
2 copy exch sub 10025 div exch
...
/name /Y def
degN
71.52 48.996872451926
2 copy exch sub 5363 div exch
% converts edges to centers
1 index .5 mul sub
3 -1 roll
2 index .5 mul add
...
/reflectance
{[X Y | band T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA1.250m_16_days_%s[band]_reflectance.dat.gz)
...
/NDVI
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA1.250m_16_days_NDVI.dat.gz)
...
/VI_Quality
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA1.250m_16_days_VI_Quality.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
...
/EVI
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA1.250m_16_days_EVI.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
/missing_value -3000 def
/valid_min -2000 def
...
/view_zenith_angle
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesNA_v006/%Y[T]/A%Y%j[T]NA1.250m_16_days_view_zenith_angle.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
