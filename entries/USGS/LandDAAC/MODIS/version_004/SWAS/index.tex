...
output image corners (lat/lon):
    UL:  40.000000000000 60.000000000000
    UR:  40.000000000000 94.000534161179
    LL:  -0.002062980579 60.000000000000
    LR:  -0.002062980579 94.000534161179

output image corners (X-Y projection units):
    UL:  60.000000000000 40.000000000000
    UR:  94.000534161179 40.000000000000
    LL:  60.000000000000 -0.002062980579
    LR:  94.000534161179 -0.002062980579

     band               type lines smpls pixsiz      min    max   fill
  1) 250m 16 days NDVI  INT16 18043 15336 0.0022  -2000  10000  -3000

End Time:  Mon Oct 23 17:16:54 2006
\begin{ingrid}
continuedataset:
/long_name (South West Asia) def
/iridl:hasSemantics [(iridl:Asia_Indonesia) (irigaz:Asia_South_319_0)]def
grid:
/name /X def
degE
60.  94.000534161179
 2 copy exch sub 15336 div exch
...
first
1 index
{(/Data/data21/usgs/landdaac/componentimagesAF_v004/A%Y%j[T]AF3.250m_16_days_MIR_reflectance.dat.gz) [T]}
removeextrausing
3 1 roll
...
/reflectance
{[X Y | band T]
(/Data/data21/usgs/landdaac/componentimagesAF_v004/A%Y%j[T]AF3.250m_16_days_%s[band]_reflectance.dat.gz)
...
/NDVI
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesAF_v004/A%Y%j[T]AF3.250m_16_days_NDVI.dat.gz)
...
/NDVI_Quality
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesAF_v004/A%Y%j[T]AF3.250m_16_days_NDVI_Quality.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
...
/EVI
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesAF_v004/A%Y%j[T]AF3.250m_16_days_EVI.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
/missing_value -3000 def
/valid_min -2000 def
...
/EVI_Quality
{[X Y | T]
(/Data/data21/usgs/landdaac/componentimagesAF_v004/A%Y%j[T]AF3.250m_16_days_EVI_Quality.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
/missing_value 65535 def
/valid_min 0 def
