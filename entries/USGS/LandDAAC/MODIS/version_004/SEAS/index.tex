...
2000
{
dup  1 1 ymd2rjt 96 add 2000 1 1 ymd2rjt sub
exch
16. exch
...
16.
systemtime
    systemtime2ymd ymd2rjt 2000 1 1 ymd2rjt sub
2 index 
     sub
    16 div
    cvi
...
first
1 index
{(/Data/data8/usgs/landdaac/componentimagesAS_v004/A%Y%j[T]AS1.250m_16_days_MIR_reflectance.dat.gz) [T]}
removeextrausing
3 1 roll
...
/expires last 2000 1 1 ymd2rjt add 16 add
3 add % processing time
rjt2ymd ymd2systemtime
%(/Data/data8/usgs/landdaac/getmodisAS.rerun) fileexists?
%{
...
/reflectance
{[X Y | band T]
(/Data/data8/usgs/landdaac/componentimagesAS_v004/A%Y%j[T]AS1.250m_16_days_%s[band]_reflectance.dat.gz)
...
/NDVI
{[X Y | T]
(/Data/data8/usgs/landdaac/componentimagesAS_v004/A%Y%j[T]AS1.250m_16_days_NDVI.dat.gz)
...
/NDVI_Quality
{[X Y | T]
(/Data/data8/usgs/landdaac/componentimagesAS_v004/A%Y%j[T]AS1.250m_16_days_NDVI_Quality.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
...
/EVI
{[X Y | T]
(/Data/data8/usgs/landdaac/componentimagesAS_v004/A%Y%j[T]AS1.250m_16_days_EVI.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
/missing_value -3000 def
/valid_min -2000 def
...
/EVI_Quality
{[X Y | T]
(/Data/data8/usgs/landdaac/componentimagesAS_v004/A%Y%j[T]AS1.250m_16_days_EVI_Quality.dat.gz)
     [T integralgrid first secondtolast subgrid]
readdatafile:
/missing_value 65535 def
/valid_min 0 def
