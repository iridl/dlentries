...
link:
 ...
 /href (http://iridl.ldeo.columbia.edu/SOURCES/.UCSB/.CHIRPS/.v2p0/.daily-improved/.global/.0p05/.prcp/) def
...
/prcp {
 [X Y | T ]
 (/Data/ingridcache/ftp/chg-ftpout.geog.ucsb.edu/pub/org/chg/products/CHIRPS-2.0/global_daily/tifs/p05/%Y[T]/chirps-v2.0.%Y[T].%m[T].%d[T].tif.gz/chirps-v2.0.%Y[T].%m[T].%d[T].tif) [T] readdatafile:
