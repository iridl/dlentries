...
link:
/name (source) def
/href (ftp://ftp.chc.ucsb.edu/pub/org/chc/products/CHIRPS-2.0/global_daily/tifs/p25/) def
:link
...
T { (/Data/data23/UCSB/CHIRPS/v2p0/daily-improved/p25/%Y[T]/chirps-v2.0.%Y[T].%m[T].%d[T].tif) [T]} removeextrausing
 name exch def
...
/prcp {
 [X Y | T ]
(/Data/data23/UCSB/CHIRPS/v2p0/daily-improved/p25/%Y[T]/chirps-v2.0.%Y.%m.%d[T].tif) [T] readdatafile:
