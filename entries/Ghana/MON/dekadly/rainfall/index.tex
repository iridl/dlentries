...
31 Aug 2015 julian_day
%This sets up the last time step according to current systemtime
%systemtime (%d %b %Y) 12 strftime interp julian_day
dekadGRID
/defaultvalue {last} def
def
:datasetdefs
%This checks on data files to remove time steps for which there are no data
%  T
%   { (/Data/data23/Ghana/MON/dekadly/rainfall/rr_mrg_%Y[T]%m[T]%d[dekad].nc) [T dup day2dom 5. add 10. div toi4 /name /dekad def]}removeextrausing
...
/rfe{
[X Y | T]
(/Data/data23/Ghana/MON/dekadly/rainfall/rr_mrg_%Y[T]%m[T]%d[dekad]_MON.nc)
...
/rfe_mergeddiff {
  rfe
  SOURCES .Ghana .MON .dekadly .climatologies .rfe
   T 2 index .T
     a: .first cvsunits
       :a: .last cvsunits :a
      RANGE
