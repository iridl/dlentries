...
{
IRIDB
     (select caption as prov_name,caption as province,the_geom from mal_level_1 order by caption) (province) openqueryby
...
{
IRIDB
     (select adm2 as dist_name,adm2 as district,adm1,the_geom from mal_level_2 order by adm2) (district) openqueryby
...
/caWASP12 {
 SOURCES .MaliMeteo .ENACTS .rainfall .CLM .monthly .WASP .wasp_functions .WASP12
  [X Y]REORDER
%  dup
