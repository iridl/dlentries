\begin{ingrid}
%//local/datalib/data/DataCatalog/entries/TMA/All/dekadly/index.tex
...
:grid
 ...
 /rfe_merged{
[ X Y | T] (/Data/data23/TMA/ENACTS/Version3/Data/RR/Merged/OpStns/rfe_mrg_OpStns_%Y[T]%m[T]%-d[dekad].nc)
...
/rfe_mergeddiff { %starts a variable and names it
  ...
  SOURCES .TMA .All .dekadly .climatologies .rfe_merged %selects rfe_adj dekadal climatology
...
/long_name (Merged Gauge-Satellite Rainfall Anomaly) def %gives the variable a more descriptive name
...
/rfe_mergeddiff_percent {
  ...
  rfe_merged
  SOURCES .TMA .All .dekadly .climatologies .rfe_merged
   T 2 index .T
     a: .first cvsunits
       :a: .last cvsunits :a
      RANGE
