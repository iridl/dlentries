...
/rfe{
[X Y | T]
(/Data/data23/madagascar_v2/MON/dekadal/rainfall/rr_mrg_%Y[T]%m[T]%d[dekad]_MON.nc) 
...
:readdatafile
%cmorph_dekad_colors
startcolormap transparent  white LightYellow LemonChiffon  LightCyan cyan SteelBlue RoyalBlue MediumBlue NavyBlue DarkSlateBlue SlateBlue LightSlateBlue violet PaleVioletRed LightPink pink pink endcolormap
}defasvarsilent
...
/rfe_mergeddiff {
  rfe
   SOURCES .Madagascar_v2 .MON .dekadal .climatologies .rfe
   T 2 index .T
     a: .first cvsunits
       :a: .last cvsunits :a
      RANGE
