...
/description (Final Weekly Data in 512x256-grid) def
...
3 Jan 1991 julian_day 01 Jan 1960 julian_day sub 0.5 add
7.0
11 May 2023 julian_day 01 Jan 1960 julian_day sub 0.5 add
/pointwidth 7. def
:grid

[X Y | /NVZ 2 NewIntegerGRID T]
(/Data/data6/noaa/cpc/precip/CBO_V1/512x256-WKLY/%Y/Final/CBO_V1_512x256-WKLY.lnx.%Y%m%d[endweek])
[  
  T dup c: 3.
     /units /days def
     :c
