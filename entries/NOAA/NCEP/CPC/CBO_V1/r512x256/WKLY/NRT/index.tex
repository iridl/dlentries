...
/description (Near-Real Time Weekly Data in 512x256-grid) def
...
18 May 2023 julian_day 01 Jan 1960 julian_day sub 0.5 add
7.0
systemtime systemtime2ymd
exch 3 -1 roll julian_day 01 Jan 1960 julian_day sub
2 index 0.5 sub sub dup 7 mod sub
2 index add
/pointwidth 7. def
:grid

T {
(/Data/data6/noaa/cpc/precip/CBO_V1/512x256-WKLY/%Y/NRT/CBO_V1_512x256-WKLY.lnx.%Y%m%d[endweek])
[
  T dup c: 3.
     /units /days def
     :c
