\begin{ingrid}
/long_name (June 2013 Release) def
 continuedataset:
 datasetdefs:
/prcp_mmperday_colors {
 ...
 /defaultvalue { 2512 } def
 .5 
 1.
 30 2013 1979 sub 73 mul add .5 sub  %enddate
 :grid
 dataset:
 /name /ver1 def
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/pentad/v1306/v1306.rain1.r4) def
 :file
 :variable
 variable:
 /name /error def
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/pentad/v1306/v1306.err1.r4) def
 :file
 :variable
 :dataset
 dataset:
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/pentad/v1306/v1306.rain2.r4) def
 :file
 :variable
 variable:
 /name /error def
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/pentad/v1306/v1306.err2.r4) def
 :file
 :variable
 :dataset
 :dataset
