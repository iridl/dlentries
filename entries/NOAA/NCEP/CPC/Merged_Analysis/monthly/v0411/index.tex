\begin{ingrid}
/long_name (November 2004 Release) def
 continuedataset:
 datasetdefs:
...
link:
/name (v0507) def
/href (http://iridl.ldeo.columbia.edu/SOURCES/.NOAA/.NCEP/.CPC/.Merged_Analysis/.monthly/.v0507/) def
/description (Merged Analysis July 2005 release) def
...
/standard_name (time) def
 monthtime
 /fullname (Month) def
 /defaultvalue { 16 Sep 2004 ensotime } def
 /pointwidth 1 def
 16 Jan 1979 ensotime 
1
16 Sep 2004 ensotime %enddate
 :grid
 dataset:
 /name /ver1 def
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/monthly/v0411/v0411.rain1.r4) def
 :file
 :variable
 variable:
 /name /error def
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/monthly/v0411/v0411.err1.r4) def
 :file
 :variable
 :dataset
 dataset:
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/monthly/v0411/v0411.rain2.r4) def
 :file
 :variable
 variable:
 /name /error def
 ...
 file:
 direct
 /name (/Data/data5/noaa/cac/cmap/monthly/v0411/v0411.err2.r4) def
 :file
 :variable
 :dataset
 :dataset
