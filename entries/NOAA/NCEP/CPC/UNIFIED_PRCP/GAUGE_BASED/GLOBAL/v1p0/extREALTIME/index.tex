\begin{ingrid}
    ...
    /name /extn def
    grids: T :grids
    values: /.gz /.gz /RT.gz /RT.gz  /.RT.gz /.RT.gz /.RT /.RT /.RT.gz /.RT.gz /.RT :values
    :variable
    ...
    /last_modified T .last_modified def
     ...
     [ X Y | /NVZ 2 NewIntegerGRID T ] (/Data/data6/noaa/cpc/unified_prcp/global/v1p0/%s[vrsn]/%Y[T]/PRCP_CU_GAUGE_V1.0GLB_0.50deg.lnx.%Y[T]%m[T]%d[T]%s[extn]) [T extn vrsn] readdatafile:
    ...
    /c9120 {
    rain
      T (1991) (0000 31 Dec 2020) RANGE
      T to366daysample
      [YR]average
    DATA 0 AUTO RANGE
    /long_name (1991-2020 Precipitation Climatology) def
    }defasvarcache
    
    :dataset
    
    c9120 .DOY name exch def
