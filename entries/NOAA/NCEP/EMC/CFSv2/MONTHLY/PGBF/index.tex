...
(/Data/data22/noaa/ncep/cfsv2/reforecast.monthly/%Y/%Y%m%d[S]%2.2d[M]/pgbf%Y%m%d[S]%2.2d[M].01.%Y%m[T].avrg.grb2) [M L S T]
readdatafile: 
...
0C_isotherm 0 Zvariable: /name (HGT) def /long_name (Geopotential Height) def /units (gpm) def :Zvariable
0C_isotherm 0 Zvariable: /name (RH) def /long_name (Relative Humidity) def /units (%) def :Zvariable
highest_tropospheric_freezing_level 0 Zvariable: /name (HGT) def /long_name (Geopotential Height) def /units (gpm) def :Zvariable
