...
:grid
%S{(/Data/data22/noaa/ncep/cfsv2/fcst/%Y[S]/%m[S]/%d[S]/18/ocnh.01.%Y[S]%m[S]%d[S]18.%Y[T]%m[T].avrg.grib.grb2) [S  dup L .last add /name /T def]}
...
(/Data/data22/noaa/ncep/cfsv2/fcst/%Y[S]/%m[S]/%d[S]/%2.2d[M]/ocnh.01.%Y[S]%m[S]%d[S]%2.2d[M].%Y[T]%m[T].avrg.grib.grb2) [M L S T] 
readdatafile: 
...
surface 0  Zvariable:/name (UFLX) def /long_name (U-Component of Momentum Flux) def /units (N s-2) def :Zvariable
surface 0  Zvariable:/name (VFLX) def /long_name (V-Component of Momentum Flux) def /units (N s-2) def :Zvariable
