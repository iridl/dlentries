...
:grid
%S{(/Data/data22/noaa/ncep/cfsv2/fcst/%Y[S]/%m[S]/%d[S]/18/flxf.01.%Y[S]%m[S]%d[S]18.%Y[T]%m[T].avrg.grib.grb2) [S  dup L .last add /name /T def]}
...
(/Data/data22/noaa/ncep/cfsv2/fcst/%Y/%m/%d[S]/%2.2d[M]/flxf.01.%Y%m%d[S]%2.2d[M].%Y%m[T].avrg.grib.grb2) [M L S T] 
readdatafile: 
%/gribparam 84 def
%/gribNumBits 14 def
