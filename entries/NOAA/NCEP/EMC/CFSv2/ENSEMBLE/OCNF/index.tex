...
5
2012 6 30 ymd2d365c 1960 1 1 ymd2d365c sub
:grid
S gridvalues
...
(/Data/data22/noaa/ncep/cfsv2/reforecast.monthly/%Y[sampleS]/%Y[sampleS]%m[sampleS]%d[sampleS]%2.2d[M2hour]/ocnf%Y[sampleS]%m[sampleS]%d[sampleS]%2.2d[M2hour].01.%Y[T]%m[T].avrg.grb2) [M L S M2hour
sampleS 0. replaceNaN T]
readdatafile: 
...
surface 0  Zvariable:/name (TMP) def /long_name (Temperature) def /units (Kelvin_scale) def 0. maskle :Zvariable
