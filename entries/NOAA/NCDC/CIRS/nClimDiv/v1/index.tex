...
(/Data/data7/noaa/ncdc/cirs/nClimDiv/v1/nclimdiv.cuf) continuewithCUF
...
/href (ftp://ftp.ncdc.noaa.gov/pub/data/cirs/climdiv/) def
:link
link:
/name (transition to nClimDiv) def
/description (Readme file describing transition from Climate Divisions dataset to nClimDiv) def
/href (ftp://ftp.ncdc.noaa.gov/pub/data/cirs/climdiv/div-dataset-transition-readme.txt) def
:link
link:
/name (format of divisional data) def
/description (Readme file describing format of divisional data files) def
/href (ftp://ftp.ncdc.noaa.gov/pub/data/cirs/climdiv/divisional-readme.txt) def
:link
link:
/name (drought variables) def
/description (Readme file describing drought variables and their format) def
/href (ftp://ftp.ncdc.noaa.gov/pub/data/cirs/climdiv/drought-readme.txt) def
:link
link:
/name (nClimDiv overview) def
/description (PDF presentation:  An Overview of NCDC's New Climate Division Dataset) def
/href (ftp://ftp.ncdc.noaa.gov/pub/data/cirs/climdiv/nCLIMDIV-briefing-cirs.pdf) def
:link
...
file:
 formatted
 /name (/Data/data7/noaa/ncdc/cirs/nClimDiv/v1/divarea.txt) def
:file
:variable
