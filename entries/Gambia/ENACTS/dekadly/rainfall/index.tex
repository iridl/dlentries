...
-16.98125 0.0375 dup 86.0 mul 2 index add
...
13.01875 0.0375 dup 23.0 mul 2 index add
...
/rfe{
[X Y | T]
(/data/audreyv/mydata/Gambia/dekadly/rainfall/rfe_mrg_%Y[T]%m[T]%d[dekad].nc)
...
/rfe_mergeddiff { 
  rfe
  SOURCES .Gambia .ENACTS .dekadly .climatologies .rfe
   T 2 index .T 
     a: .first cvsunits
       :a: .last cvsunits :a
      RANGE
