...
/historical {
 SOURCES .SMNH .SdC .estacion .historical
  ...
  (MeanTemp)
   ...
   (PerDA) eq
   {a: .TMinA dataflag :a: .TMaxA dataflag :a mul }if
  (1)
   /DayStart parameter
   ( ) append
   (Jan)
   ...
   (0)
    ...
    (0.5)
     ...
     (MeanTemp)
      /seasonalStat parameter
      (MinTemp) eq
      {nip 3 -1 roll .TMinA T 4 -2 roll seasonalAverage}if
  /seasonalStat get_parameter
   (MaxTemp) eq
   {nip 3 -1 roll .TMaxA T 4 -2 roll seasonalAverage}if
  /seasonalStat get_parameter
   (MeanTemp) eq
   {nip 3 -1 roll a: .TMaxA :a: .TMinA :a add 2.0 div T 4 -2 roll seasonalAverage}if
  /seasonalStat get_parameter
   (HDD) eq
   {4 -1 roll a: .TMaxA :a: .TMinA :a add 2.0 div 3 -1 roll sub 0 maskge abs 3 -2 roll flexseastotZeroFill}if
  /seasonalStat get_parameter
   (CDD) eq
   {4 -1 roll a: .TMaxA :a: .TMinA :a add 2.0 div 3 -1 roll sub 0 maskle abs 3 -2 roll flexseastotZeroFill}if
  /seasonalStat get_parameter
   (NumCD) eq
   {4 -1 roll .TMinA 4 -3 roll flexseasonalfreqLT}if
  /seasonalStat get_parameter
   (NumHD) eq
   {4 -1 roll .TMaxA 4 -3 roll flexseasonalfreqGT}if
  /seasonalStat get_parameter
   (PerDA) eq
   {pop pop T exch 0.0 seasonalAverage}if
  /seasonalStat get_parameter
   (PerDA) eq
...
/seasonalStat get_parameter (HDD) eq { /long_name (Heating Degree Days) def}if
...
/seasonalStat get_parameter (MinTemp) eq { /long_name (Minimum Temperature) def}if
/seasonalStat get_parameter (MaxTemp) eq { /long_name (Maximum Temperature) def}if
/seasonalStat get_parameter (HDD) eq { /long_name (Heating Degree Days) def
DATA 0 null RANGE
}if
