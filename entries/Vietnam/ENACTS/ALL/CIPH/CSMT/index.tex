...
/Annual_Sum {
  SOURCES .Vietnam .ENACTS .ALL .monthly .climatologies .rfe_merged
  80 flagge
  % X 102.025 0.05 109.475 GRID
  % Y 8.025 0.05 23.475 GRID

  SOURCES .Vietnam .ENACTS .ALL .monthly .climatologies .tmean
  dup
