...
class ECCC_REF_Model(ECMWF_REFModelTaskBase):
    """
    Model used to download the ECCC hindcast models from the ECMWFDataServer cdsapi()
                ...
                self.all_models[modeltype].extend([
                    {
                        ...
                        "actual_size": 90899640,
                        "class": ECCC_REF_Model.s2s_class,
                        "dataset": ECCC_REF_Model.dataset,
                        "date": y_m_d,
                        "expver": "prod",
                        "hdate": hdate_y_m_d,
