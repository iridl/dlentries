...
my $lcldir = '/Data/data23/SENAMHI/Prec/V1.0_O/daily/'; 
my $host = 'ftp.senamhi.gob.pe';				#ftp host
my $remotedir = '/PISCO/Prec/V1.0_O/daily';               #array of directories
@datelist = ();
@newfiles = ();

# get monthly files

chdir "/Data/data23/SENAMHI/Prec/V1.0_O/daily" or die "Couldn't change local directory! (1)\n";
