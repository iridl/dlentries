...
chdir("/Data/data7/noaa/ncep/gmsm") or die "Couldn't chdir to output directory\n";

$flag=0;
foreach $line (getdatafiles("ftp://ftp.cpc.ncep.noaa.gov/wd51yf/global_monthly/gridded_binary/current_month/",qr/w\.20[0-9][0-9].*/)) {
    $flag=1;
