...
# this script updates CanSIPS-IC3, which is the new ECCC seasonal forecast model as of Dec 2021
# Dec 03, 2021
#
...
# /Data/data23/NMME/CanSIPS_IC3.D/Forecast.D/ 
# 
# The CanSIPSv2 forecast dataset in the Data Library is placed here:  http://iridl.ldeo.columbia.edu/SOURCES/.Models/.NMME/.CanSIPS-IC3/.FORECAST/.MONTHLY/
#
# The CanSIPS-IC3 files we download include both an initialization date at the very beginning of the file name, which can actually be a day in the previous 
...
my $lcldir = '/Data/data23/NMME/CanSIPS_IC3.D/Forecast.D/'; 
...
chdir "/Data/data23/NMME/CanSIPS_IC3.D/Forecast.D" or die "Couldn't change local directory! (1)\n";
