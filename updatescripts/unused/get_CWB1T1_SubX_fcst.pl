...
#
# See the documentation.txt file in /volume1/DataLibrary/SubX/CWB/CWB1T1/forecast/ for more information
#
# The data files are downloaded from the following remote ftp location at CWB:
#
# ftp://pds.cwb.gov.tw/575
#
# The data files are downloaded locally to phoenix to /volume1/DataLibrary/SubX/CWB/CWB1T1/forecast/ 
#
...
my $lcldir = '/volume1/DataLibrary/SubX/CWB/CWB1T1/forecast/'; 
...
chdir "/volume1/DataLibrary/SubX/CWB/CWB1T1/forecast" or die "Couldn't change local directory! (1)\n";
