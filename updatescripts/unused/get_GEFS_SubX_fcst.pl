...
#
# See the documentation.txt file in /volume1/DataLibrary/SubX/EMC/GEFS/forecast/documentation.txt for more information.
#
...
#
# The data files are downloaded locally to phoenix to /volume1/DataLibrary/SubX/EMC/GEFS/forecast/YYYYmmdd/ 
#
...
#
# The data files are downloaded locally to phoenix to /volume1/DataLibrary/SubX/EMC/GEFS/ROMI/
#
# --------
#
...
my $lcldir = '/volume1/DataLibrary/SubX/EMC/GEFS/forecast/'; 
...
# get weekly files, first checking to see if the new weekly directory has been created
 ...
 $checkdir = '/volume1/DataLibrary/SubX/EMC/GEFS/forecast/' . "$nextdate";
 chomp $checkdir;
 ...
 if(-d $checkdir){
  chdir "/volume1/DataLibrary/SubX/EMC/GEFS/forecast/$nextdate" or die "Couldn't change local directory! (1)\n";
...
# download ROMI forecast files
   ...
   #chdir "/volume1/DataLibrary/SubX/EMC/GEFS/ROMI" or die "Couldn't change local directory! (2)\n";
