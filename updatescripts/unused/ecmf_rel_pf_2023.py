...
##  Mar 16 2021 add 6-hourly 10m wind(u and v) and Tmax, Tmin
...
for i in np.arange(0,315,7):
    ...
    dir_pf = TOPLEVEL+"/ECMWF/S2S/ECMF/REL/PF/"+year_fcst + "/"

    targetfile = dir_pf + ocenter+"_rel_" + ftype + "_pl_zuvt" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_pl_z" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_pl_t" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_pl_u" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_pl_v" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_"+ftype + "_pl_q" + mdateymdstr+mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_pl_w" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_sfc_sfc" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_sfc_sfc3_" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_sfc_sfc2_" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_sfc_sfc6_" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_sfc_sfc62_" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_"+ ftype + "_da_sfc" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_pt_pv" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_o2d" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_o2d1_" + mdateymdstr + mdateymdstr + ".grb"
    ...
    targetfile = dir_pf + ocenter + "_rel_" + ftype + "_o2d2_" + mdateymdstr + mdateymdstr + ".grb"
