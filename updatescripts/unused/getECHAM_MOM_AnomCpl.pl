...
#Script to update Models NMME IRI-ECHAM4p5-AnomalyCoupled MONTHLY
...
my $texdir = '/Data/data1/DataCatalog/entries/Models/NMME/IRI-ECHAM4p5-AnomalyCoupled/MONTHLY/';
my $lcldir = '/data/dstore4/iri/modelling/daved/BlueFin.D/ECHAM4.5_MOM3DirCpl2.D/EXP.D/TestCpl1b.D/Forecast_AnomCoup_SSMI_P80Cl_P80An.D/PutTogPost.D/NMME_AllEns_ForDL.D/'; 
my $host = 'nino.ldeo.columbia.edu';				#ftp host
my $remotedir = qw(/pub/daved/NMME.D/RealTime.D/AnomalyCoupled.D/);               #array of directories
@datelist = ();
@newfiles = ();
...
chdir "/data/dstore4/iri/modelling/daved/BlueFin.D/ECHAM4.5_MOM3DirCpl2.D/EXP.D/TestCpl1b.D/Forecast_AnomCoup_SSMI_P80Cl_P80An.D/PutTogPost.D/NMME_AllEns_ForDL.D/$localmondir" or die "Couldn't change local directory! (1)\n";
