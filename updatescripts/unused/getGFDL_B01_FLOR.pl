...
# Added more documentation 25 Jul 2019
...
#
# ftp://ftp.gfdl.noaa.gov/pub/Oar.Gfdl.Nmme/Vandendool/$month_retrospective_B01_FLOR/
#
# and 
#
# ftp://ftp.gfdl.noaa.gov/pub/Oar.Gfdl.Nmme/Vandendool/$month_retrospective_B01_FLOR/additional_variables/
#
# where $month is the lowercase full name of the start month, such as
#
# august_retrospective_B01_FLOR/
#
# These month-of-year subdirectories contain data files for each variable and each of 12 ensemble members.  
...
# /Data/data23/NMME/GFDL_CM2.5_FLOR_B01.D/
#
# with month-of-year subdirectories holding the files for each start month but for all years.
#
# The GFDL CM2.5-FLOR-B01 forecast dataset in the Data Library is here: 
...
my $lcldir = '/Data/data23/NMME/GFDL_CM2.5_FLOR_B01.D/'; 
...
$remcurmondir = "$remcurmon" . "_retrospective_B01_FLOR/";
chomp $remcurmondir;
...
chdir "/Data/data23/NMME/GFDL_CM2.5_FLOR_B01.D/$localmondir" or die "Couldn't change
local directory! (1)\n";
