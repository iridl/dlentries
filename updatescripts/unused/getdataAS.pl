...
$rerun="getmodisAS.rerun";
$nowfile="getmodisAS.now";
#Tiles:
...
# dates are in format YYYY.mm.dd, e.g. 2004.11.01
    ...
    $dataset="SOURCES .USGS .LandDAAC .MODIS .SEAS .NDVI";
#    $dataset="home .benno .USGS .landdaac .SEAS .NDVI";
