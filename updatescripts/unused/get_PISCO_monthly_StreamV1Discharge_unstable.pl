...
my $lcldir = '/Data/data23/SENAMHI/Stream/v1/unstable/monthly/GR2M/Discharge/'; 
my $host = 'ftp.senamhi.gob.pe';				#ftp host
my $remotedir = '/PISCO/Stream/v1/unstable/monthly/GR2M/Discharge';               #array of directories
@datelist = ();
@newfiles = ();
#@newfiles1 = ();
...
chdir "/Data/data23/SENAMHI/Stream/v1/unstable/monthly/GR2M/Discharge" or die "Couldn't change local directory! (1)\n";
