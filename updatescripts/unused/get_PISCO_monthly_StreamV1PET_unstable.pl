...
require "$libdir/crendentials.pl";

my ($user, $passwd) = get_credential("pisco_hydro");

my $lcldir = '/Data/data23/SENAMHI/Stream/v1/unstable/monthly/GR2M/PET/'; 
my $host = 'ftp.senamhi.gob.pe';				#ftp host
my $remotedir = '/PISCO/Stream/v1/unstable/monthly/GR2M/PET';               #array of directories
@datelist = ();
@newfiles = ();
#@newfiles1 = ();
...
chdir "/Data/data23/SENAMHI/Stream/v1/unstable/monthly/GR2M/PET" or die "Couldn't change local directory! (1)\n";
