...
# now changed to run on iridlc4 20110311
# now changed to run on gfs2geo1 & gfs2mon1 20190107
use POSIX "ctime";
...
$mstoredir="/Data/data23/blyon/";
#$mstoredir="/Data/data1/iri/monitoring/blyon/";
#$mstoredir="/c12/blyon/";
$tmpdir="/usr/tmp";
if(-d $mstoredir){
chdir "$mstoredir" or die "Couldn't chdir to output directory\n";
}
else {
...
chdir($tmpdir) or die "Couldn't chdir to temp directory\n";
if($needany){
