...
# from USGS get_file.pl
    ...
    my ($uid, $passwd) = get_credential("earthdata_nasa");

    my $uid = "mbell";    # Can hard code, not secret
    my $passwd = "&I1abnedd"; # Can hard code ONLY if script secured
    ...
    my $netrc = 0;
    my $dir = getcwd;
    my $cookie_file = "$ENV{HOME}/.cookies2";
