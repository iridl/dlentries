...
#
# See the documentation.txt file in /Data/SubX/ESRL/FIMr1p1/documentation.txt for more information.
#
...
#
# The data files are downloaded locally to phoenix to /Data/SubX/ESRL/FIMr1p1/forecast/ 
#
...
#
# The data files are downloaded locally to phoenix to /Data/SubX/ESRL/FIMr1p1/ROMI/ 
#
# --------
#
...
my ($user, $passwd) = get_credential("anonymous_old");

my $lcldir = '/Data/SubX/ESRL/FIMr1p1/forecast/'; 
...
#chdir "/Data/SubX/ESRL/FIMr1p1/ROMI" or die "Couldn't change local directory! (2)\n";
