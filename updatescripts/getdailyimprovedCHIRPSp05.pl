...
chdir "/Data/data23/UCSB/CHIRPS/v2p0/daily-improved/p05" or die "Couldn't change directory\n";
...
$mydir = "/Data/data23/UCSB/CHIRPS/v2p0/daily-improved/p05/" . "$yrprevmon";
chomp $mydir;
...
# if you have all the latest month's files already, end the update script before you try to download
    ...
    @newfilestest = getdatafilesdirect("ftp://ftp.chc.ucsb.edu/pub/org/chc/products/CHIRPS-2.0/global_daily/tifs/p05/$yrprevmon/",qr/chirps-v2.0.$yrprevmon.$monprevmon.01.tif*/);
    if(@newfilestest) {
    ...
    if($ct == 1) {
        ...
        @newfiles = getdatafilesdirect("ftp://ftp.chc.ucsb.edu/pub/org/chc/products/CHIRPS-2.0/global_daily/tifs/p05/$yrprevmon/",qr/chirps-v2.0.$yrprevmon.$monprevmon.\d\d.tif*/);
...
#getdatafiles("ftp://ftp.chc.ucsb.edu/pub/org/chc/products/CHIRPS-2.0/global_daily/tifs/p05/2017/",qr/chirps-v2.0.2017.06.\d\d.tif.gz/);
#getdatafiles("ftp://ftp.chc.ucsb.edu/pub/org/chc/products/CHIRPS-2.0/global_daily/tifs/p05/2017/",qr/chirps-v2.0.2017.06.\d\d.tif/);
